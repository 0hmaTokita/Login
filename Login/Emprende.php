...
<body class="contenedor">
    <header class="header">
        ...
        <div class="cab2">
            ...
            <div class="login"><a href="login.php">INGRESA/REGISTRARTE</a></div>
            <div class="megusta">
        ...
        <form name="form1">
            <div id="bPrincipal">
                <div id="b1">
                    ...
                    <input type="text" name="nombre" id="correo">
                    <br>
                    <label>Asunto</label>
                    <input type="text" name="nombre" id="asunto">
                    <br>
                    <label>Dejanos tu comentario</label>
                    <textarea name="msj" id="tex"></textarea>
                </div>
                <input type="button" value="Enviar" id="btn2" onclick="funEnviar()"><br>
            </div>
        </form>
    </main>
    ...
    <footer class="footer">
        <div class="piePadre1">
            ...
            <div class="pie4">
                ...
                <a href="login.php">REGISTRARTE</a>
